...
export async function getAllCreativeTypeSlugs() {
    const data = await fetchAPI(`
    query NewQuery {
        creativeTypes {
          edges {
...
export async function getCreativeTypeBySlug(id) {
    const data = await fetchAPI(`
    query NewQuery($id: ID!) {
        creativeType(idType: SLUG, id: $id) {
          name
          slug
          creativeTypeInformation {
            svgIcon {
    ...
    return data?.creativeType
}
export async function getCreativesByTypeSlug(id) {
    const data = await fetchAPI(`
    query NewQuery($id: ID!, $first: Int) {
        creativeType(idType: SLUG, id: $id) {
            name
            slug
...
export async function getAllCreativeTypesWithCreatives() {
    const data = await fetchAPI(`
...
export async function getSingleCreativeTypeWithCreatives(id) {
    const data = await fetchAPI(`
    query NewQuery($first: Int) {
        creativeTypes {
          edges {
